...
func (c *worldServiceClient) LoadMission(ctx context.Context, in *LoadMissionRequest, opts ...grpc.CallOption) (*LoadMissionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoadMissionResponse)
	err := c.cc.Invoke(ctx, WorldService_LoadMission_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWorldServiceServer) ExpireEntity(context.Context, *ExpireEntityRequest) (*ExpireEntityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExpireEntity not implemented")
}
...
func (UnimplementedWorldServiceServer) LoadMission(context.Context, *LoadMissionRequest) (*LoadMissionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method LoadMission not implemented")
}
...
func _WorldService_LoadMission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoadMissionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorldServiceServer).LoadMission(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorldService_LoadMission_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorldServiceServer).LoadMission(ctx, req.(*LoadMissionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WorldService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _WorldService_LoadMission_Handler,
		},
		{
			MethodName: "TimeSync",
