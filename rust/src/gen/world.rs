...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ControllerReconciliationRequest {
    #[prost(string, tag = "1")]
    pub controller: ::prost::alloc::string::String,
}
/// An entity with Config on this controller was added, changed, or removed.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ControllerDeviceConfigurationEvent {
    #[prost(enumeration = "ControllerDeviceConfigurationEventType", tag = "1")]
    pub t: i32,
    #[prost(message, optional, tag = "2")]
    pub config: ::core::option::Option<Entity>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ControllerReconciliationEvent {
    #[prost(oneof = "controller_reconciliation_event::Event", tags = "2")]
    pub event: ::core::option::Option<controller_reconciliation_event::Event>,
}
/// Nested message and enum types in `ControllerReconciliationEvent`.
pub mod controller_reconciliation_event {
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Event {
        #[prost(message, tag = "2")]
        Config(super::ControllerDeviceConfigurationEvent),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum ControllerDeviceConfigurationEventType {
...
impl ControllerDeviceConfigurationEventType {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    /// The values are not transformed in any way and thus are considered stable
    /// (if the ProtoBuf definition does not change) and safe for programmatic use.
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::ControllerDeviceConfigurationEventNew => {
                "ControllerDeviceConfigurationEventNew"
            }
            Self::ControllerDeviceConfigurationEventChanged => {
                "ControllerDeviceConfigurationEventChanged"
            }
            Self::ControllerDeviceConfigurationEventRemoved => {
                "ControllerDeviceConfigurationEventRemoved"
            }
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "ControllerDeviceConfigurationEventNew" => {
                Some(Self::ControllerDeviceConfigurationEventNew)
            }
            "ControllerDeviceConfigurationEventChanged" => {
                Some(Self::ControllerDeviceConfigurationEventChanged)
            }
            "ControllerDeviceConfigurationEventRemoved" => {
                Some(Self::ControllerDeviceConfigurationEventRemoved)
            }
            _ => None,
        }
    }
...
pub mod controller_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn reconcile(
            &mut self,
            request: impl tonic::IntoRequest<super::ControllerReconciliationRequest>,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::ControllerReconciliationEvent>,
            >,
            tonic::Status,
        > {
            self.inner
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("world.ControllerService", "Reconcile"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("world.ControllerService", "RestartConnector"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod controller_service_server {
    ...
    pub trait ControllerService: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the Reconcile method.
        type ReconcileStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::ControllerReconciliationEvent,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        async fn reconcile(
            &self,
            request: tonic::Request<super::ControllerReconciliationRequest>,
        ) -> std::result::Result<tonic::Response<Self::ReconcileStream>, tonic::Status>;
        async fn restart_connector(
            &self,
            request: tonic::Request<super::RestartConnectorRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RestartConnectorResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/world.ControllerService/Reconcile" => {
                    #[allow(non_camel_case_types)]
                    struct ReconcileSvc<T: ControllerService>(pub Arc<T>);
                    impl<
                        T: ControllerService,
                    > tonic::server::ServerStreamingService<
                        super::ControllerReconciliationRequest,
                    > for ReconcileSvc<T> {
                        type Response = super::ControllerReconciliationEvent;
                        type ResponseStream = T::ReconcileStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ControllerService>::reconcile(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/world.ControllerService/RestartConnector" => {
                    #[allow(non_camel_case_types)]
                    struct RestartConnectorSvc<T: ControllerService>(pub Arc<T>);
                    impl<
                        T: ControllerService,
                    > tonic::server::UnaryService<super::RestartConnectorRequest>
                    for RestartConnectorSvc<T> {
                        type Response = super::RestartConnectorResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ControllerService>::restart_connector(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RestartConnectorSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "world.ControllerService";
